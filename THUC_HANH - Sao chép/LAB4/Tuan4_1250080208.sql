-- xoa comment thua, code viet nhu sinh vien thuong lam
-- luu y: neu chay tren datagrip thi khong can set serveroutput

-- 1. view bao cao tong hop
...
-- 4. Test code
-- ban co the chay tung dong nay hoac boi den het
