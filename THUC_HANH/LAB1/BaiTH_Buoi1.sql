...
INSERT INTO s_image
VALUES
  (1, 'JPEG', 'Y', 'img1.jpg', EMPTY_BLOB());
INSERT INTO s_image
VALUES
  (2, 'PNG', 'Y', 'img2.png', EMPTY_BLOB());
INSERT INTO s_image
VALUES
  (3, 'JPEG', 'N', 'img3.jpg', EMPTY_BLOB());
INSERT INTO s_image
VALUES
  (4, 'GIF', 'Y', 'img4.gif', EMPTY_BLOB());
INSERT INTO s_image
VALUES
  (5, 'PNG', 'N', 'img5.png', EMPTY_BLOB());
COMMIT;
SELECT *
FROM s_image;
...
VALUES
  (1, 'Y', 'desc1.txt', 'Description 1');
INSERT INTO s_longtext
VALUES
  (2, 'N', 'desc2.txt', 'Description 2');
INSERT INTO s_longtext
VALUES
  (3, 'Y', 'desc3.txt', 'Description 3');
INSERT INTO s_longtext
VALUES
  (4, 'Y', 'desc4.txt', 'Description 4');
INSERT INTO s_longtext
VALUES
  (5, 'N', 'desc5.txt', 'Description 5');
COMMIT;
SELECT *
FROM s_longtext;
...
INSERT INTO s_emp
VALUES
  (1, 'Smith', 'John', 'jsmith', TO_DATE('14/05/1990', 'DD/MM/YYYY'), NULL, NULL, 'President', 50, 5000, NULL);
INSERT INTO s_emp
VALUES
  (2, 'Doe', 'Jane', 'jdoe', TO_DATE('26/05/1991', 'DD/MM/YYYY'), NULL, 1, 'VP Sales', 20, 3500, 10);
INSERT INTO s_emp
VALUES
  (3, 'Nga', 'Lan', 'nlan', TO_DATE('10/01/1991', 'DD/MM/YYYY'), NULL, 2, 'Sales Rep', 20, 1500, 15);
INSERT INTO s_emp
VALUES
  (4, 'Nguyen', 'Nam', 'nnam', TO_DATE('15/06/1991', 'DD/MM/YYYY'), NULL, 1, 'Manager', 10, 2000, NULL);
INSERT INTO s_emp
VALUES
  (5, 'Tran', 'Binh', 'tbinh', TO_DATE('05/04/1992', 'DD/MM/YYYY'), NULL, 4, 'Clerk', 31, 1400, NULL);
COMMIT;
SELECT *
FROM s_emp;
...
VALUES
  (101, 'Cust A', '111-222', '123 Main St', 'City A', 'State A', 'USA', '10001', 'EXCELLENT', 3, 1, 'Good');
INSERT INTO s_customer
VALUES
  (102, 'Cust B', '333-444', '456 Oak St', 'City B', 'State B', 'USA', '20002', 'GOOD', 3, 2, NULL);
INSERT INTO s_customer
VALUES
  (103, 'Cust C', '555-666', '789 Pine St', 'City C', 'State C', 'USA', '30003', 'POOR', 3, 1, 'Late');
INSERT INTO s_customer
VALUES
  (104, 'Cust D', '777-888', '321 Elm St', 'City D', 'State D', 'USA', '40004', 'EXCELLENT', 3, 3, NULL);
INSERT INTO s_customer
VALUES
  (105, 'Cust E', '999-000', '654 Maple St', 'City E', 'State E', 'USA', '50005', 'GOOD', 3, 4, 'Ok');
COMMIT;
SELECT *
FROM s_customer;
...
VALUES
  (1, 1, '100 Warehouse Rd', 'City A', 'State A', 'USA', '10001', '111-111', 4);
INSERT INTO s_warehouse
VALUES
  (2, 2, '200 Warehouse Rd', 'City B', 'State B', 'USA', '20002', '222-222', 4);
INSERT INTO s_warehouse
VALUES
  (3, 3, '300 Warehouse Rd', 'City C', 'State C', 'USA', '30003', '333-333', 4);
INSERT INTO s_warehouse
VALUES
  (4, 4, '400 Warehouse Rd', 'City D', 'State D', 'USA', '40004', '444-444', 4);
INSERT INTO s_warehouse
VALUES
  (5, 5, '500 Warehouse Rd', 'City E', 'State E', 'USA', '50005', '555-555', 4);
COMMIT;
SELECT *
FROM s_warehouse;
...
VALUES
  (1, 'Pro Ski', 'bicycle and ski equipment', 1, 1, 150.00, 'Ea');
INSERT INTO s_product
VALUES
  (2, 'Pro Bike', 'mountain bicycle', 2, 2, 500.00, 'Ea');
INSERT INTO s_product
VALUES
  (3, 'Helmet', 'safety helmet', 3, 3, 45.00, 'Ea');
INSERT INTO s_product
VALUES
  (4, 'Gloves', 'winter gloves', 4, 4, 25.00, 'Pr');
INSERT INTO s_product
VALUES
  (5, 'Boots', 'hiking boots', 5, 5, 120.00, 'Pr');
COMMIT;
SELECT *
FROM s_product;
...
INSERT INTO s_ord
VALUES
  (101, 101, TO_DATE('01/01/2026', 'DD/MM/YYYY'), TO_DATE('05/01/2026', 'DD/MM/YYYY'), 3, 150000, 'CREDIT', 'Y');
INSERT INTO s_ord
VALUES
  (102, 102, TO_DATE('10/01/2026', 'DD/MM/YYYY'), TO_DATE('15/01/2026', 'DD/MM/YYYY'), 3, 85000, 'CASH', 'Y');
INSERT INTO s_ord
VALUES
  (103, 103, TO_DATE('20/01/2026', 'DD/MM/YYYY'), NULL, 3, 120000, 'CREDIT', 'N');
INSERT INTO s_ord
VALUES
  (104, 104, TO_DATE('05/02/2026', 'DD/MM/YYYY'), TO_DATE('10/02/2026', 'DD/MM/YYYY'), 3, 200000, 'CREDIT', 'Y');
INSERT INTO s_ord
VALUES
  (105, 105, TO_DATE('15/02/2026', 'DD/MM/YYYY'), NULL, 3, 50000, 'CASH', 'N');
COMMIT;
SELECT *
FROM s_ord;
...
VALUES
  (1, 1, 500, 50, 1000, NULL, TO_DATE('01/03/2026', 'DD/MM/YYYY'));
INSERT INTO s_inventory
VALUES
  (2, 2, 300, 30, 800, NULL, TO_DATE('02/03/2026', 'DD/MM/YYYY'));
INSERT INTO s_inventory
VALUES
  (3, 3, 150, 20, 500, 'Supplier delay', TO_DATE('05/03/2026', 'DD/MM/YYYY'));
INSERT INTO s_inventory
VALUES
  (4, 4, 0, 100, 2000, 'Out of stock', NULL);
INSERT INTO s_inventory
VALUES
  (5, 5, 800, 100, 1500, NULL, TO_DATE('10/03/2026', 'DD/MM/YYYY'));
COMMIT;
SELECT *
FROM s_inventory;
...
SELECT last_name,
  ...
  TO_CHAR(
               ...
               'Ddspth "of" Month YYYY') AS "Ngay xet tang luong"
FROM s_emp;
